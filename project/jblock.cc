...
void Jblock::rotateCW(std::vector<std::shared_ptr<Row>> theGrid) {
    ...
    if (pos = "faceup") {
        ...
        (theGrid[x2]->(*rowData[y2 + 2])).setS("J");
        ...
        (theGrid[x2 + 2]->(*rowData[y2 - 2])).setS("J");
        ...
        // Set the new cells
        (theGrid[x - 2]->(*rowData[y + 2])).setS("J");
